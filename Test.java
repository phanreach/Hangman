...
public class Test {
    public static void main(String[] args) throws FileNotFoundException {
        Scanner sc = new Scanner(new File("C:/Users/Phan Reach/Documents/hangmanword.txt"));
        ...
        GuestPlayer player ; // Initialize to null
        ...
        if (choice == 1) {
            ...
            if (Authentication.authenticateUser(username, password, email)) {
                ...
                player = new RegisterPlayer(username, 0);
            } else {
                System.out.println("Invalid username or password. Login failed.");
                System.out.println("Please enter your name: ");
                String name = scanner.nextLine();
                player = new GuestPlayer(name, 0) {
                    @Override
        ...
        if (player instanceof RegisterPlayer) {
            ...
            System.out.println("Registered player score: " + registerPlayer.getScore());
        }
